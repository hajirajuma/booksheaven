...
export default function CategoriesPage () {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Category Buttons at the top - Updated for responsive design */}
      <div className="shadow-sm border-b items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 overflow-x-auto">
          <ul className="flex items-center gap-4 md:gap-6 lg:gap-8 xl:gap-20 flex-nowrap md:flex-wrap overflow-x-auto pb-2">
            <li className="flex-shrink-0"><Button variant="outline" className="whitespace-nowrap">Education</Button></li>
            <li className="flex-shrink-0"><Button variant="outline" className="whitespace-nowrap">Romance</Button></li>
            <li className="flex-shrink-0"><Button variant="outline" className="whitespace-nowrap">History</Button></li>
            <li className="flex-shrink-0"><Button variant="outline" className="whitespace-nowrap">Technology</Button></li>
            <li className="flex-shrink-0"><Button variant="outline" className="whitespace-nowrap">Life</Button></li>
          </ul>
        </div>
      </div>
